module "frontend" {
  ...
  #key_name = aws_key_pair.openvpn.key_name # key pair is not required because we are using joindevops ami
...
resource "aws_lb_listener_rule" "frontend" {
  ...
  condition {
    host_header {
      values = ["${var.frontend_tags.Component}.web-${var.environment}.${var.zone_name}"]
    }
  }
}